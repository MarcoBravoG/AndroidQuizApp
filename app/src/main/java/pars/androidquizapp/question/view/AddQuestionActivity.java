...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryDatabase = CategoryDatabase.getInstance(AddQuestionActivity.this);
        ...
        categoryList = categoryDatabase.categoryDao().getAllCategories();
        if(data == null){
        ...
        add_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (update) {
                    ...
                    categoryDatabase.questionDao().updateQuestion(questions);
    ...
    private static class InsertTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... objs) {
            long j = activityReference.get().categoryDatabase.questionDao().insert(question);
            question.setId(j);
            return true;
        }
